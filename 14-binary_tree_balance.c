...
{
	int right_bal = 0, left_bal = 0, total_bal = 0;

	if (tree)
	{
		left_bal = ((int)binary_tree_height_b(tree->left));
		right_bal = ((int)binary_tree_height_b(tree->right));
		total_bal = left_bal - right_bal;
	}
	return (total_bal);
}
